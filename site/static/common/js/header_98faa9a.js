$(document).ready(function(){
    ...
    $search.hover(function(){
        $(this).find('input#search').remove();
        $(this).append('<span class="searchInput"><input name="search" type="text" id="search" placeholder="查询"></span>');
        $('.content').find('ul.nav li.searchInput').fadeIn('slow');
    },function(){
